...
public class Main {
    public static void main(String[] args) {
          ...
          // Codigo para registro de clientes
...
//           ///////codigo para activar membresia-descomentar para activarlo//////
...
//DatosClientes cliente = session.get(DatosClientes.class, 4);
//
//if (cliente != null) {
//    // Activar membresía por 10 días
//    servicio.activarMembresia(cliente.getId(), 10);
//
...
//session.close(); /////aqui termina el codigo para activar membresia-cierra session
            ...
            //// AQUI INICIA EL CODIGO PARA BORRAR CLIENTE
...
//           // para pedir listado de clientes
